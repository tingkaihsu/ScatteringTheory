...
This section would outline the formalism that enable us to calculate the probabilities of the scattering and cross-sections.
Part of the content of this section is highly related to some sections in quantum mechanics part.
\end{document}