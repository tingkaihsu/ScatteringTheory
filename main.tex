...
\begin{equation}
    V\ket*{\Psi_{\mathbf{k}}^{\text{in}}} = \int{d^3q\,\ket*{\Phi_{\mathbf{q}}}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}}
\end{equation}
Thus equation (1.8) becomes,
\[\ket*{\Psi_{\mathbf{k}}^{\text{in}}} = \ket*{\Phi_{\mathbf{k}}} + \hbar^3\int{d^3q\,\left(E(|\mathbf{k}|) - H_0 + i\epsilon\right)^{-1}\ket*{\Phi_{\mathbf{q}}}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}}\]
\begin{equation}
    = \ket*{\Phi_{\mathbf{k}}} + \hbar^3\int{d^3q\,\left(E(|\mathbf{k}|) - E(|\mathbf{q}|) + i\epsilon\right)^{-1}\ket*{\Phi_{\mathbf{q}}}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}}
\end{equation}
In calculating the integral over $\mathbf{k}$ in equation (1.3),
\[\int{d^3k\,g(\mathbf{k})\frac{\exp(-i\hbar t\mathbf{k}^2/2\mu)}{E(|\mathbf{k}|)-E(q)+i\epsilon}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}}\]
\[=\int{d\Omega}\int_{0}^{\infty}{dk\,k^2g(\mathbf{k})}\frac{\exp(-i\hbar t\mathbf{k}^2/2\mu)}{E(k)-E(q)+i\epsilon}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}\]
...
\[=\int{d\Omega}\int_{0}^{\infty}{dE\,\frac{\mu k}{\hbar^2}g(\mathbf{k})}\frac{\exp(-iEt/\hbar)}{E-E(q)+i\epsilon}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{k}}^{\text{in}}}\]
...
\[=\int{d\Omega\,g(\Omega)\frac{\mu q}{\hbar^2}}\bra*{\Phi_{\mathbf{q}}}V\ket*{\Psi_{\mathbf{q}}^{\text{in}}}\int_{\text{around E(q)}}{dE\,\frac{\exp(-iEt/\hbar)}{E-E(q)+i\epsilon}}\]
